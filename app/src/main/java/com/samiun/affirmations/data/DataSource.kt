...
class DataSource {
    fun loadAffirmations():List<Affirmation>{
        return listOf(
            Affirmation(R.string.affirmation1, R.drawable.affirmantions1,R.string.affirmation1Broad),
            ...
            Affirmation(R.string.affirmation4, R.drawable.affirmantions4,R.string.affirmation4Broad),
            ...
            Affirmation(R.string.affirmation10, R.drawable.affirmantions10,R.string.affirmation10Broad),
        )
    }
